...
5. [ ] **Notifications push (navigateur)** : encart « par appareil » + hint plateforme (Windows / Mac) visible

6. [ ] Activer push **sur cet appareil** → statut « Push activé sur cet appareil » ; désactiver ici ne coupe pas un autre terminal déjà abonné
...
- [x] **Notifications** (cloche) : lien « Notifications système » → Paramètres → Intégrations si permission `default`
