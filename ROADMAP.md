...
- [x] **Gantt timeline interactif** — Clic tâche/phase → édition ; poignées resize début/fin ; drag centre avec preview live ; sous-tâches datées interactives ; phases drag/resize via `updatePhaseApi` ; contraintes dates via `moveTodo` + modales ; E2E prod §G validé (2026-06-08)
