...
const ERROR_CODE_KEYS: Record<string, TranslationKey> = {
  ...
  TASK_PHASE_DATE_MISMATCH: "errors.code.TASK_PHASE_DATE_MISMATCH",
  TASK_PHASE_SLOT_MISMATCH: "errors.code.TASK_PHASE_SLOT_MISMATCH",
  TASK_MOVE_CONFLICT: "errors.code.TASK_MOVE_CONFLICT",
  TASK_BLOCKED_BY_ACTIVE: "errors.code.TASK_BLOCKED_BY_ACTIVE",
  DEPENDENCY_PROJECT_REQUIRED: "errors.code.DEPENDENCY_PROJECT_REQUIRED",
  DEPENDENCY_INVALID: "errors.code.DEPENDENCY_INVALID",
  DEPENDENCY_SELF: "errors.code.DEPENDENCY_SELF",
  DEPENDENCY_NOT_FOUND: "errors.code.DEPENDENCY_NOT_FOUND",
  DEPENDENCY_CROSS_PROJECT: "errors.code.DEPENDENCY_CROSS_PROJECT",
  DEPENDENCY_CYCLE: "errors.code.DEPENDENCY_CYCLE",
  ...
  IMPORT_NOTION_INVALID: "errors.code.IMPORT_NOTION_INVALID",
  NOTION_NOT_CONNECTED: "errors.code.NOTION_NOT_CONNECTED",
  NOTION_API_ERROR: "errors.code.NOTION_API_ERROR",
  NOTION_DATABASE_KIND_MISMATCH: "errors.code.NOTION_DATABASE_KIND_MISMATCH",
  NOTION_CONTACTS_KIND_MISMATCH: "errors.code.NOTION_CONTACTS_KIND_MISMATCH",
  NOTION_DATA_KIND_MISMATCH: "errors.code.NOTION_DATA_KIND_MISMATCH",
  NOTION_OAUTH_NOT_CONFIGURED: "errors.code.NOTION_OAUTH_NOT_CONFIGURED",
  MONDAY_NOT_CONNECTED: "errors.code.MONDAY_NOT_CONNECTED",
  MONDAY_API_ERROR: "errors.code.MONDAY_API_ERROR",
  IMPORT_MONDAY_INVALID: "errors.code.IMPORT_MONDAY_INVALID",
  MONDAY_OAUTH_NOT_CONFIGURED: "errors.code.MONDAY_OAUTH_NOT_CONFIGURED",
  MONDAY_DOCS_SCOPE_MISSING: "errors.code.MONDAY_DOCS_SCOPE_MISSING",
  MONDAY_DOC_EXPORT_FAILED: "errors.code.MONDAY_DOC_EXPORT_FAILED",
  MONDAY_DOC_NO_TABLE: "errors.code.MONDAY_DOC_NO_TABLE",
  SHARE_LINK_INVALID: "errors.code.SHARE_LINK_INVALID",
