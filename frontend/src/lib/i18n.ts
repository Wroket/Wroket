...
const translations = {
  ...
  "meet.createMeet": { fr: "Créer un meeting Google Meet", en: "Create Google Meet" },
  "meet.joinMeet": { fr: "Rejoindre le meeting Google Meet", en: "Join Google Meet" },
  "meet.created": { fr: "Meeting créé. Lien copié dans le presse-papier !", en: "Meeting created. Link copied to clipboard!" },
  "meet.errorNoGoogle": { fr: "Connectez votre Google Calendar dans les Paramètres pour créer un meeting.", en: "Connect your Google Calendar in Settings to create a meeting." },
  "meet.error": { fr: "Impossible de créer le meeting. Vérifiez vos droits Google Calendar.", en: "Could not create the meeting. Check your Google Calendar permissions." },
