...
const translations = {
  ...
  "agenda.defaultBookingCalendarHint": { fr: "Choisissez le calendrier par défaut utilisé pour créer les bookings.", en: "Choose the default calendar used to create bookings." },
