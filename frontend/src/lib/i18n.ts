...
const translations = {
  ...
  "matrix.radarModeEisenhowerDesc": {
    fr: "Importance stratégique × urgence — quatre quadrants.",
    en: "Strategic importance × urgency — four quadrants.",
  },
  ...
  "tutorial.step1.desc": { fr: "Saisissez un titre — priorité et urgence suivent la matrice d'Eisenhower. Effort, échéance, tags, sous-tâches, pièces jointes, créneau planifié. Réordonnancement par glisser-déposer (vue Liste). Double-clic pour tout éditer. Récurrence (quotidien, hebdo, mensuel). Basculer l'affichage : Toutes / Personnelles / Reçues / Déléguées.", en: "Enter a title — priority and urgency follow the Eisenhower matrix. Effort, deadline, tags, subtasks, attachments, scheduled slot. Reorder via drag & drop (List view). Double-click for full edit. Recurrence (daily, weekly, monthly). Toggle scope: All / Personal / Assigned to me / Assigned out." },
  "tutorial.step2.title": { fr: "Vues, filtres, import & export", en: "Views, filters, import & export" },
  "tutorial.step2.desc": { fr: "3 vues : Liste, Cards (Eisenhower) et Radar. Filtres avancés (projet, assignation, échéance, tag). Commentaires, @mentions et réactions. Export CSV ou JSON ; import avec aperçu puis confirmation. La barre du haut : recherche globale (tâches, projets, notes).", en: "3 views: List, Cards (Eisenhower) and Radar. Advanced filters (project, assignee, deadline, tag). Comments, @mentions and reactions. Export CSV or JSON; import with preview then confirm. Top bar: global search (tasks, projects, notes)." },
  "tutorial.step3.title": { fr: "Projets, Kanban & Gantt", en: "Projects, Kanban & Gantt" },
  "tutorial.step3.desc": { fr: "Projets et sous-projets (un niveau), phases, tags projet. Vues Board, Kanban et Gantt avec glisser-déposer des tâches. Import projet CSV (nouveau projet) ou JSON ; sur une fiche projet, import de tâches (CSV) avec création de phases si besoin. Réorganisation des projets par drag & drop, annulation sous 10 s. Indicateurs de santé et temps estimé par phase.", en: "Projects and sub-projects (one level), phases, project tags. Board, Kanban and Gantt views with drag & drop. Import project via CSV (new project) or JSON; on a project page, import tasks (CSV) with phases created as needed. Reorder projects via drag & drop,10s undo. Health badges and estimated time per phase." },
  "tutorial.step4.title": { fr: "Agenda & Google Calendar", en: "Agenda & Google Calendar" },
  "tutorial.step4.desc": { fr: "Vues Jour, Semaine et Mois. Tâches Wroket + plusieurs comptes Google (Agenda > Gérer les agendas), couleurs par compte. Double-clic sur un créneau : création rapide de tâche. Double-clic sur une tâche : édition. Tâches récurrentes visibles sur la période. Créneaux suggérés selon priorité et deadline.", en: "Day, Week and Month views. Wroket tasks + multiple Google accounts (Agenda > Manage Calendars), colors per account. Double-click a slot: quick task create. Double-click a task: edit. Recurring tasks shown across the range. Suggested slots based on priority and deadline." },
  "tutorial.step5.title": { fr: "Bloc-notes intelligent", en: "Smart notepad" },
  "tutorial.step5.desc": { fr: "Hors ligne avec synchro au retour réseau. Commandes / : /task, /assign, /deadline, /project, /date, /time, /code, /warning. Dossiers, tags, partage équipe, lien optionnel à une tâche. Export Markdown, import/export CSV ou JSON.", en: "Offline with sync when back online. Slash: /task, /assign, /deadline, /project, /date, /time, /code, /warning. Folders, tags, team share, optional link to a task. Markdown export; CSV/JSON import & export." },
  "tutorial.step6.title": { fr: "Équipes & collaboration", en: "Teams & collaboration" },
  "tutorial.step6.desc": { fr: "Équipes avec rôles, invitations par email, tableau de bord consolidé. Assignation de tâches (accepter/refuser), notifications in-app et rappels d'échéance. Webhooks sortants (Slack, Discord, Teams) dans Paramètres > Intégrations.", en: "Teams with roles, email invites, consolidated dashboard. Task assignment (accept/decline), in-app notifications and deadline reminders. Outgoing webhooks (Slack, Discord, Teams) under Settings > Integrations." },
  "tutorial.step7.title": { fr: "Vous êtes prêt !", en: "You're all set!" },
  "tutorial.step7.desc": { fr: "Paramètres : profil, langue, fuseau, heures de travail, sécurité (2FA TOTP ou e-mail), mot de passe, export RGPD, intégrations. Archives des tâches et page Notifications. L'ampoule sur chaque page résume les fonctions utiles ; la liste des tâches se rafraîchit aussi au retour sur l'onglet.", en: "Settings: profile, language, timezone, working hours, security (2FA TOTP or email), password, GDPR export, integrations. Task archives and Notifications page. The bulb on each page summarizes features; the task list also refreshes when you return to the tab." },
  ...
  "help.dashboard.radar": { fr: "Radar Eisenhower et répartition par quadrant", en: "Eisenhower radar and quadrant breakdown" },
