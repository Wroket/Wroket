...
const translations = {
  ...
  "dashboard.scopeAllNoSubtasks": { fr: "Périmètre: vue Toutes (hors sous-tâches)", en: "Scope: All view (excluding subtasks)" },
  "dashboard.scopeAssignedNoSubtasks": { fr: "Périmètre: attribuées (hors sous-tâches)", en: "Scope: assigned (excluding subtasks)" },
  "dashboard.scopeDelegatedNoSubtasks": { fr: "Périmètre: déléguées (hors sous-tâches)", en: "Scope: delegated (excluding subtasks)" },
