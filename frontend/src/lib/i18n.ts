...
const translations = {
  ...
  "agenda.manageDesc": { fr: "Connectez vos comptes Google, sélectionnez les calendriers à afficher et choisissez le calendrier par défaut pour les bookings.", en: "Connect your Google accounts, select calendars to display, and choose the default calendar for bookings." },
  ...
  "meet.createMeet": { fr: "Créer une réunion", en: "Create meeting" },
  "meet.joinMeet": { fr: "Rejoindre la réunion", en: "Join meeting" },
  ...
  "meet.errorNoGoogle": { fr: "Connectez votre Google Calendar dans les Paramètres pour créer une réunion.", en: "Connect your Google Calendar in Settings to create a meeting." },
