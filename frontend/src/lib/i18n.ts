...
const translations = {
  ...
  "filter.clearAll": { fr: "Réinitialiser", en: "Clear all" },
  "filter.advancedTitle": { fr: "Filtres avancés", en: "Advanced filters" },
  "filter.advancedHint": { fr: "Combinez les filtres pour affiner vos résultats. Ils s'appliquent à toutes les vues (Liste, Cards, Radar).", en: "Combine filters to refine your results. They apply to all views (List, Cards, Radar)." },
