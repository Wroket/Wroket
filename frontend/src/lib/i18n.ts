...
const translations = {
  ...
  "notes.homeTiles": { fr: "Vos espaces", en: "Your spaces" },
  ...
  "gantt.quickPanel.title": { fr: "Ajuster la barre", en: "Adjust bar" },
  "gantt.quickPanel.shiftDays": { fr: "Décaler (jours)", en: "Shift (days)" },
  "gantt.quickPanel.alignPhase": { fr: "Aligner sur la phase", en: "Align to phase" },
  "gantt.quickPanel.openEdit": { fr: "Ouvrir l'édition", en: "Open edit" },
  "gantt.quickPanel.apply": { fr: "Appliquer", en: "Apply" },
