...
const translations = {
  ...
  "meet.error": { fr: "Impossible de créer la réunion. Vérifiez vos droits Google Calendar.", en: "Could not create the meeting. Check your Google Calendar permissions." },
  ...
  "meet.errorInvitees": { fr: "Un ou plusieurs invités sont invalides ou refusés par Google.", en: "One or more invitees are invalid or rejected by Google." },
