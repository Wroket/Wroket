...
const translations = {
  ...
  "help.todos.scope": { fr: "Filtre d'affichage : Toutes, Personnelles, Reçues (assignées à vous), Déléguées (que vous assignez)", en: "Display filter: All, Personal, Assigned to me, Delegated (tasks you assigned)" },
  ...
  "help.settings.integrations": { fr: "Webhooks Slack, Discord, Microsoft Teams (événements tâches et invitations)", en: "Slack, Discord, Microsoft Teams webhooks (task and invite events)" },
