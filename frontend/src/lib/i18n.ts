...
const translations = {
  ...
  "settings.deliverySmtpHint": {
    fr: "L’envoi email nécessite que le serveur (SMTP) soit configuré côté Wroket.",
    en: "Email delivery requires SMTP to be configured on the Wroket server.",
  },
