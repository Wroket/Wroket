...
const translations = {
  ...
  "agenda.defaultBookingCalendarHint": { fr: "Choisissez un calendrier inscriptible comme défaut pour créer les bookings.", en: "Choose a writable calendar as default for bookings." },
