...
const STEPS: TutorialStep[] = [
  ...
  { titleKey: "tutorial.step5.title", descKey: "tutorial.step5.desc", icon: "📅", color: "from-sky-500 to-cyan-600" },
  { titleKey: "tutorial.step6.title", descKey: "tutorial.step6.desc", icon: "🚀", color: "from-rose-500 to-pink-600" },
];
