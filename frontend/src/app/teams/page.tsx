  ...
  return (
    <AppShell>
      <div className="max-w-[1000px] space-y-6">
        <div>
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-slate-100">{t("teams.title")}</h2>
          <p className="text-sm text-zinc-500 dark:text-slate-400 mt-1">{t("teams.subtitle")}</p>
        </div>
        <div className="bg-white dark:bg-slate-900 rounded-md border border-zinc-200 dark:border-slate-700 p-10 text-center">
          ...
          <p className="text-sm text-zinc-500 dark:text-slate-400">{t("teams.comingSoon")}</p>
        </div>
      </div>
    </AppShell>
  );
