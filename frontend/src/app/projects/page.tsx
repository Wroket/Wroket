  ...
  return (
    <AppShell>
      <div className="max-w-[1000px] space-y-6">
        <div>
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-slate-100">Mes projets</h2>
          <p className="text-sm text-zinc-500 dark:text-slate-400 mt-1">Organisez vos tâches par projet</p>
        </div>
